         ...
         CASE ( BC_DIRICHLET )
            ...
            SELECT CASE ( STENCIL )
               ...
               CASE ( STENCIL_3D7PT )
                  ...
                  CALL MG_FLUX_ACCUMULATE_2D5PT_3D7PT ( GRID, IVAR, IERR )

               CASE ( STENCIL_3D27PT )

                  CALL MG_FLUX_ACCUMULATE_3D27PT ( GRID, IVAR, IERR )
               ...
               CASE ( STENCIL_2D9PT )
                  ...
                  CALL MG_FLUX_ACCUMULATE_2D9PT ( GRID, IVAR, IERR )
            ...
            END SELECT
            MG_PERF%TIME_BC_PE = MG_PERF%TIME_BC_PE + MG_TIMER() - TIME_START
