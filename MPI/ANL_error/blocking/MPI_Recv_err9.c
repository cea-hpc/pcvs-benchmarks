...
*
* NOTES:
*        Recv test 9, sends messages from node zero to each of the
...
#define  PROG_NAME   "MPI_Recv_err09"
#define  MESS01      "Try to receive a message larger than Recv count"
...
int main(int argc, char *argv[])
{
   ...
   /*
	...
	{
	    ierr = MPI_Recv(buffer, (MPITEST_current_rank-1)*7, MPI_INT, 0, 0,			    MPI_COMM_WORLD, &recv_stat);
