...
#define TEST_NAME "MPI_Intercomm_create_err1"
#define TEST_DESCRIPTION "local_comm=MPI_COMM_NULL"
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    ierr2 = MPI_Intercomm_create(MPI_COMM_NULL, local_leader, peer_comm, remote_leader, tag, &newintercomm);
