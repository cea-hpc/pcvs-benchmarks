...
that remote_leader be valid for nodes other then the leaders so the other
nodes down't need to check it.  As a result some implemenations won't
check for remote_leader=MPI_ANY_SOURCE in other nodes and they will hang
...
#define TEST_NAME "MPI_Intercomm_create_err8"
#define TEST_DESCRIPTION "remote_leader=MPI_ANY_SOURCE"
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    local_leader = 0;
    /* set peer_comm to a copy of MPI_COMM_WORLD */
