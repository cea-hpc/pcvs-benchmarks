...
******************************************************************************/
#define  TEST_TYPE   "MPI_Ibsend"
#define  PROG_NAME   "MPI_Ibsend_err9"
#define  MESS01      "Mismatched data types between Ibsend and Recv"
...
int main(int argc, char *argv[])
{
    int
        ...
        dest,	        /* Destination of Ibend message                      */
	...
	if (MPITEST_me == 0)
	{
	    dest = 1;
            ...
            ierr = MPI_Ibsend(float_send, 10, MPI_FLOAT, dest, 1234, MPI_COMM_WORLD, &request);
	}
