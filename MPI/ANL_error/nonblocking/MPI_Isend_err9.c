...
*
*  Buffered Asynchronous Isend error tests
*  -----------------------------------------
...
#define  PROG_NAME   "MPI_Isend_err9"
#define  MESS01      "Mismatched data types between Isend and Recv"
...
int main(int argc, char *argv[])
{
	...
	if (MPITEST_me == 0)
	{
	    dest = 1;
            ...
            ierr = MPI_Isend(float_send, 10, MPI_FLOAT, dest, 1234, MPI_COMM_WORLD, &request);
	}
