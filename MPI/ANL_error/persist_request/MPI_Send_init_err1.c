...
-----------------------------------------------------------------------------*/
/******************************************************************************
*                          Error test for MPI_Send_init
*
* This test verifies that the correct error is returned if MPI_Send_init is
* called with an invalid argument.
*
*
*  MPI_Send_init error tests
*  -----------------------------------
...
*
******************************************************************************/
#define  TEST_TYPE   "MPI_Send_init"
#define  PROG_NAME   "MPI_Send_init_err1"
#define  MESS01      "Destination Rank negative"
...
{
    int
        dest,	        /* Destination of Send_init message                  */
    ...
    */
    ...
    /* Let all nodes do the invalid Send_init  */
    ...
    ierr = MPI_Send_init(input, 1, MPI_CHAR, dest, 0, MPI_COMM_WORLD, &request);
