...
#define  PROG_NAME   "MPI_Send_init_err8"
#define  MESS01      "non-existant data type (MPI_DATATYPE_NULL)"
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    ierr = MPI_Send_init(input, messlength, MPI_DATATYPE_NULL, dest, 0, MPI_COMM_WORLD, &request);
