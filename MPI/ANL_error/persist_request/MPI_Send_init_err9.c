...
* 9)  Use a mis-matched data type ....................... [MPI_ERR_TYPE]
*-------------------------------------------------------------------------
*
* Test history:
*   created  03/96  jh
...
#define  PROG_NAME   "MPI_Send_init_err9"
#define  MESS01      "Mismatched data types between Send_init and Recv"
...
int main(int argc, char *argv[])
{
	...
	if (MPITEST_me == 0)
	{
	    dest = 1;
            ...
            ierr = MPI_Send_init(float_send, 10, MPI_FLOAT, dest, 1234, MPI_COMM_WORLD, &request);
