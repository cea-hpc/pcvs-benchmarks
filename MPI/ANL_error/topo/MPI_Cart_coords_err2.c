...
****************************************************************************/
#define  DIMENSIONS      1
#define  TEST_DESC       "MPI_Cart_coords:  call with MPI_COMM_NULL communicator"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_coords_err2:  Call with MPI_COMM_NULL communicator ");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Cart_coords(MPI_COMM_NULL,
			     0,
			     1,
			     coords);
