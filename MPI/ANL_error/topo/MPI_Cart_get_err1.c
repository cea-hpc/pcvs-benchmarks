...
****************************************************************************/
#define  DIMENSIONS      1
#define  TEST_DESC       "MPI_Cart_get:  call with communicator without topology"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_get_err1:  Call with communicator without topology");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Cart_get(MPI_COMM_WORLD,
			  num_dims,
			  dim_size,
			  periods,
			  coords);
