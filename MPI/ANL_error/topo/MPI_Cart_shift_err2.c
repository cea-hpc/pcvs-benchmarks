...
****************************************************************************/
#define  DIMENSIONS  2
#define  TEST_DESC   "MPI_Cart_shift:  call with MPI_COMM_NULL communicator"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_shift_err2:  Call with MPI_COMM_NULL communicator");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Cart_shift(MPI_COMM_NULL,
		     0,
		     nshift,
		     &rank_sorc,
		     &rank_dest);
