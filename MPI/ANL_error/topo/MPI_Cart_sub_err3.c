...
****************************************************************************/
#define  DIMENSIONS      2
#define  TEST_DESC       "MPI_Cart_sub:  call with MPI_COMM_NULL communicator"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_sub_err3:  Call with MPI_COMM_NULL communicator");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Cart_sub(MPI_COMM_NULL,
			  rem_dims,
			  &sub_comm);
