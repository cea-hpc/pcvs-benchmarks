...
#define  DIMENSIONS     4
#define  MAXNODE      120
#define  TEST_DESC      "MPI_Dims_create  Negative value in Dimensions Array"
...
int main(int argc, char *argv[])
{
   int
      ...
      nnodes,			/* number of nodes in Cartesian grid                 */
   ...
   sprintf(testname, "MPI_Dims_create_err2:  Negative value in Dimensions Array");
