...
#define  PROG_NAME   "MPI_Buffer_attach_err2"
#define  MESS01      " Attach buffer of negative length"
...
int main(int argc, char *argv[])
{
	...
	/* 10-31-02: MPI-1, 7.3 states that MPI_ERR_BUFFER is for
	   invalid buffer POINTER, so MPI_ERR_BUFFER may
	   not be the most correct choice */
	if (errorclass != MPI_ERR_BUFFER && errorclass != MPI_ERR_ARG)
	{
	    fail++;
