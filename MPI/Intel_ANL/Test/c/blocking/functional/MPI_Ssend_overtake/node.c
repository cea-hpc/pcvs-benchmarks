...
int main(int argc, char *argv[])
{
	...
	{ /* receiver */
	    ...
	    /* Once the Ssend matches a receive, we can complete the first
	       receive request.  Note that it is not safe to use 
	       MPI_Request_free on a receive request, so we wait for this
	       receive to complete rather than just freeing it */
