...
This test runs on only two nodes because the standard does not require 
nodes that don't think they are leaders to look at peer_comm or 
remote_leader.
...
#define TEST_NAME "MPI_Intercomm_create_err10"
#define TEST_DESCRIPTION "remote_leader not a valid rank in peer_comm"
#define EXPECTED_ERRORS "MPI_ERR_RANK"
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    /* Initalize all the values for a bad call */
    /* set local_comm to MPI_COMM_SELF */
