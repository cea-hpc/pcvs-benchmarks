...
6)  removed
7)  Call with local_leader=MPI_ANY_SOURCE.........................[MPI_ERR_ARG/MPI_ERR_OTHER/MPI_ERR_RANK]
8)  Call with remote_leader=MPI_ANY_SOURCE........................[MPI_ERR_ARG/MPI_ERR_OTHER/MPI_ERR_RANK]
...
#define TEST_NAME "MPI_Intercomm_create_err7"
#define TEST_DESCRIPTION "local_leader=MPI_ANY_SOURCE"
#define EXPECTED_ERRORS "MPI_ERR_ARG or MPI_ERR_OTHER or MPI_ERR_RANK"
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    /* Initalize all the values for a correct call */
    ...
    if (ierr2 == MPI_SUCCESS) {
      ...
      else if ((errorclass != MPI_ERR_ARG) && (errorclass != MPI_ERR_OTHER) && (errorclass != MPI_ERR_RANK)) {
        fail++;
