...
****************************************************************************/
#define  DIMENSIONS      1
#define  TEST_DESC       "MPI_Cart_rank:  call with MPI_COMM_NULL communicator"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_rank_err2:  Call with MPI_COMM_NULL communicator ");
   ...
   if (MPITEST_me == 0) {
      ...
      coords[0] = 0;
      ierr = MPI_Cart_rank(MPI_COMM_NULL,
			   coords,
			   &rank_cart);
