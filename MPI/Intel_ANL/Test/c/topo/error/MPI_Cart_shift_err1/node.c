...
****************************************************************************/
#define  DIMENSIONS  2
#define  TEST_DESC   "MPI_Cart_shift call with communicator with no topology"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_shift_err1:  Call with communicator with no topology");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Cart_shift(MPI_COMM_WORLD,
		     0,
		     nshift,
		     &rank_sorc,
		     &rank_dest);
