...
****************************************************************************/
#define  DIMENSIONS      1
#define  TEST_DESC    "MPI_Graph_create with node count (nnodes) < 0"
...
int main(int argc, char *argv[])
{
   int
      ...
      test_nump,		/* number of processors in current
				 * communicator      */
   ...
   sprintf(testname, "Graph_create_err1:  nodes < 0");
