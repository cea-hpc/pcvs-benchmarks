...
****************************************************************************/
#define  TEST_DESC    "MPI_Graph_get called with non-graphic communicator"
...
int main(int argc, char *argv[])
{
   ...
   int
      ...
      graph_nodes[2],		/* graph nodes from Graph_get                        */
      graph_edges[2];		/* graph edges from Graph_get                        */
   ...
   sprintf(testname, "Graph_get_err1:  called with non-graphic communicator ");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Graph_get(MPI_COMM_WORLD,
			   maxindex,
			   maxedges,
			   graph_nodes,
			   graph_edges);
