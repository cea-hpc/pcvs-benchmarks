...
#define  PRNT_NODE       0
#define  DIMENSIONS      1
#define  TEST_DESC       "MPI_Graph_map with MPI_COMM_NULL communicator"
...
int main(int argc, char *argv[])
{
   int
      ...
      rank_graph,		/* rain in the graph communicator                    */
   ...
   sprintf(testname, "MPI_Graph_map_err2:  call with MPI_COMM_NULL communicator");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Graph_map(MPI_COMM_NULL,
			   nnodes,
			   index,
			   edges,
			   &newrank);
