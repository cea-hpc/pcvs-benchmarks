...
/******************************************************************************
                          ...
                          MPI Graph neighbors_count_err1
...
#define  PRNT_NODE       0
#define  DIMENSIONS      1
#define  TEST_DESC    "MPI Graph neighbors_count: call using communicator without topology"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "Graph_neighbors_count_err1:  communicator with no topology");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Graph_neighbors_count(MPI_COMM_WORLD,
				       0,
				       &neighbors);
