...
!---------------------------------------------------------------------
     ...
     &        idump, record_length, idump_sub, rd_interval
...
!---------------------------------------------------------------------
      ...
      deallocate (  &
     &    cell_coord, cell_low, cell_high, cell_size,  &
     &    start, end, slice, forcing, u, rhs, lhsc,  &
     &    backsub_info, in_buffer, out_buffer,  &
     &    cv, rhon, rhos, rhoq, cuf, q, ue, buf,  &
     &    fjac, njac, lhsa, lhsb,  &
     &    us, vs, ws, qs, rho_i, square,  &
     &    stat = ios)
