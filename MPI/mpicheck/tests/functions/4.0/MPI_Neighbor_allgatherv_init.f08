       ...
       INTEGER :: var_10
        call mpi_neighbor_allgatherv_init(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, &
       var_8, var_9, var_10)
       call pmpi_neighbor_allgatherv_init(var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, &
       var_8, var_9, var_10)
        end program main
