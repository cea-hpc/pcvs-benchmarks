      ...
      INTEGER FUNCTION test_par_section_reduct()
        IMPLICIT NONE
...
!$omp end parallel sections
        ...
        IF ( result .EQ. 0 ) THEN
          test_par_section_reduct =  1
        ELSE
          test_par_section_reduct =  0
        END IF
...
!This is the main driver to invoke different test functions
      ...
      INTEGER test_par_section_reduct
...
!      READ  (*,*) logfilename
      ...
      result=1
      WRITE (*,*) "--------------------------------------------------"
      WRITE (*,*) "Testing omp parallel sections reduction"
      WRITE (*,*) "--------------------------------------------------"
      WRITE (*,*) 
      WRITE (*,*) "testname: test_par_section_reduct"
      WRITE (*,*) "(Crosstests should fail)"
      WRITE (*,*)
      
      DO j = 1, N
        temp =  test_par_section_reduct()
        IF (temp .EQ. 1) THEN
