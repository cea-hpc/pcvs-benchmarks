...
/* 1*/	,CASE_POS( 0, 0, 0, 0, 0, 0, 0, 0, "detached")
...
/*11*/	,CASE_POS( 0, 0, 0, 0, 0, 0, 0, 1, "Min stack size")
   ...
   /* Stack play */
	...
	,CASE_POS( 0, 0, 0, 0, 0, 1, 0, 0, "Detached, Alternative stack")
	,CASE_POS( 0, 0, 0, 0, 0, 0, 1, 1, "Detached, Min stack size, no guard")
	,CASE_UNK( 0, 0, 0, 0, 0, 0, 2, 1, "Detached, Min stack size, 1p guard")
   ...
   /* Scheduling play -- all results are unknown since it might depend on the user priviledges */
	...
	,CASE_UNK( 0, 1, 1, 1, 0, 0, 0, 0, "Detached, explicit FIFO max param")
	,CASE_UNK( 0, 1, 2, 1, 0, 0, 0, 0, "Detached, explicit RR max param")
	,CASE_UNK( 0, 1, 1,-1, 0, 0, 0, 0, "Detached, explicit FIFO min param")
	,CASE_UNK( 0, 1, 2,-1, 0, 0, 0, 0, "Detached, explicit RR min param")
	,CASE_UNK( 0, 1, 1, 1, 1, 0, 0, 0, "Detached, explicit FIFO max param, alt scope")
	,CASE_UNK( 0, 1, 2, 1, 1, 0, 0, 0, "Detached, explicit RR max param, alt scope")
	,CASE_UNK( 0, 1, 1,-1, 1, 0, 0, 0, "Detached, explicit FIFO min param, alt scope")
	,CASE_UNK( 0, 1, 2,-1, 1, 0, 0, 0, "Detached, explicit RR min param, alt scope")
