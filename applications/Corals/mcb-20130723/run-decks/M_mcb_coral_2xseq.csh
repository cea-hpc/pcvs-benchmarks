...
srun --runjob-opts="--mapping TEDCBA" -N $NUM_NODES -n $TOTAL_NPROCS --ntasks-per-node=$PROCS_PER_NODE --cpus-per-task=$CORES_PER_PROC $CODE --nCores=${CORES_PER_PROC} --distributedSource --numParticles=2621440000 --nZonesX=25600 --nZonesY=51200 --xDim=16 --yDim=32 --mirrorBoundary --multiSigma --nThreadCore=$THREADS_PER_CORE
