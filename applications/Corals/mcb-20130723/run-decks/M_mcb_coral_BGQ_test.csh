...
srun --runjob-opts="--mapping TEDCBA" -N $NUM_NODES -n $TOTAL_NPROCS --ntasks-per-node=$PROCS_PER_NODE --cpus-per-task=$CORES_PER_PROC $CODE --weakScaling --nCores=${CORES_PER_PROC} --distributedSource --numParticles=20000 --multiSigma --nThreadCore=$THREADS_PER_CORE
