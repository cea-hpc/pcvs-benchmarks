...
BEGIN {
  ...
  my $modulepath = "/home/adamj/Documents/projets/gweodev/spack/share/spack/modules/linux-fedora28-x86_64";
...
sub _modulecmd {
  ...
  # 2. call modulecmdmy $retcode = system (@cmd);
printf "MODULEPATH=$ENV{MODULEPATH}".join(" ", @cmd)."\n";
