...
<xsl:param name='execbase_filter'>".*"</xsl:param>
			...
			<div id='page'>
				...
				<div id='menu-container'>
					<ul id='menu'>
						...
						<li><a>
							<xsl:attribute name="href">diff-<xsl:value-of select='translate($current_dir, "\/", "\-")'/>-output.html</xsl:attribute>
							Diff</a></li>
					</ul>
				</div>
				<div id='body'>
	...
	<div class='section'>
		...
		<table class='summary'>
			...
			<xsl:call-template name="summary-line">
				...
				<xsl:with-param name="value"><xsl:value-of select='count(//testcase) - count(//failure) - count(//error)'/></xsl:with-param>
			</xsl:call-template>
			<xsl:call-template name="summary-line">
...
<xsl:template match="testcase">
    <xsl:if test='matches(@name,execbase_filter,)'>
	<tr>
	...
	<xsl:apply-templates select='failure|success'/>
    </xsl:if>  
</xsl:template>
