...
C
C 10-31-02: I10 isn't large enough for a negative 32-bit integer.
C This shows up in the address tests when the address has the high
C bit set.
#define INT_FMT I12
...
C the entire sender & receiver buffer when error occurs
