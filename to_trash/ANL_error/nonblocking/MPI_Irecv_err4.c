...
#define  PROG_NAME   "MPI_Irecv_err04"
#define  MESS01      "Call with freed communicator"
#define  MESS02      "Call with freed communicator"
#define  ERR_NAM     "MPI_ERR_COMM"
