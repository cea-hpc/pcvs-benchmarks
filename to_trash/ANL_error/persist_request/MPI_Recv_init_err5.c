...
*
* This test verifies that the correct error is returned if MPI_Recv_init is
...
* 9)  Try to receive a message larger than Recv_init count .. [MPI_ERR_BUFFER]
*
*
...
#define  PROG_NAME   "MPI_Recv_init_err5"
...
{
    int
        source,	        /* Source of Recv_init message                           */
    ...
    int
        output[10];	/* output from Recv_init                                 */
    ...
    */
    ...
    /* Let all nodes do the invalid Recv_init  */
    ...
    ierr = MPI_Recv_init(output, 1, MPI_CHAR, source, messtag, \
