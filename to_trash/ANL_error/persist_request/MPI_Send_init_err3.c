...
#define  PROG_NAME   "MPI_Send_init_err3"
#define  MESS01      "Call Send_init with MPI_COMM_NULL communicator"
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    ierr = MPI_Send_init(input, 1, MPI_CHAR, dest, 0, MPI_COMM_NULL, &request);
