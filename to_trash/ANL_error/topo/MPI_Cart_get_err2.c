...
****************************************************************************/
#define  DIMENSIONS      1
#define  TEST_DESC       "MPI_Cart_get:  call with MPI_COMM_NULL communicator"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_get_err2:  Call with MPI_COMM_NULL communicator");
   ...
   if (MPITEST_me == 0) {
      ...
      num_dims = 1;
      ierr = MPI_Cart_get(MPI_COMM_NULL,
			  num_dims,
			  dim_size,
			  periods,
			  coords);
