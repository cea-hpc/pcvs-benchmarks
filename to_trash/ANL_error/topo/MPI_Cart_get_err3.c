...
****************************************************************************/
#define  DIMENSIONS      1
#define  TEST_DESC       "MPI_Cart_get:  call with graph communicator"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_get_err3:  Call with graph communicator");
   ...
   /* Skip if not rank 0 in comm_graph communicator */
