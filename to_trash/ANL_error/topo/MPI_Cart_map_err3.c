...
#define  DIMENSIONS  1
#define  TEST_DESC   "MPI_Cart_map: call with zero dimensions "
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_map_err3:  Call with zero dimensions");
   ...
   /* Skip if not rank 0 in comm_cart communicator */
