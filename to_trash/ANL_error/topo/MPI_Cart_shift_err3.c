...
****************************************************************************/
#define  DIMENSIONS  2
#define  TEST_DESC   "MPI_Cart_shift:  call with graph communicator"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cart_shift_err3:  Call with graph communicator");
   ...
   if (comm_graph != MPI_COMM_NULL) {
	 ...
	 ierr = MPI_Cart_shift(comm_graph,
			       0,
			       nshift,
			       &rank_sorc,
			       &rank_dest);
