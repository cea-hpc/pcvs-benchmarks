 ...
 * ==> This one is legit nothing prevents it in the standard
 * 4)  Call with a displacement = 0 ...................... [TOPOLOGY/ARG]
 * 5)  Call with a invalid shift direction value ......... [TOPOLOGY/ARG]

 ****************************************************************************/
#define  DIMENSIONS  2
#define  TEST_DESC   "MPI_Cart_shift call with displacement = 0"
...
int main(int argc, char *argv[])
{
	...
	sprintf(testname, "MPI_Cart_shift_err4:  Call with displacement = 0");
