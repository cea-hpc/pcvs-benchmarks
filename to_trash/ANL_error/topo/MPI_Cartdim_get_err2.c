...
****************************************************************************/
#define  DIMENSIONS      1
#define  TEST_DESC       "MPI_Cartdim_get:  call with MPI_COMM_NULL "
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "MPI_Cartdim_get_err2:  Call with MPI_COMM_NULL");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Cartdim_get(MPI_COMM_NULL,
			     &cart_dims);
