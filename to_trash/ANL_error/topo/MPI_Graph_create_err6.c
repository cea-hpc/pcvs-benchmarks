...
#define  DIMENSIONS      1
#define  TEST_DESC       "MPI_Graph_create with MPI_COMM_NULL"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "Graph_create_err6:  call with MPI_COMM_NULL");
   ...
   ierr = MPI_Graph_create(MPI_COMM_NULL,
			   nnodes,
			   index,
			   edges,
			   reorder,
