...
****************************************************************************/
#define  DIMENSIONS      1
#define  TEST_DESC    "MPI_Graphdims_get called with MPI_COMM_NULL"
...
int main(int argc, char *argv[])
{
   ...
   sprintf(testname, "Graphdims_get_err3:  called with MPI_COMM_NULL ");
   ...
   if (MPITEST_me == 0) {
      ...
      ierr = MPI_Graphdims_get(MPI_COMM_NULL,
			       &graph_nodes,
			       &nedges);
